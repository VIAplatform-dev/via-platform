...
export default function HelpScreen() {
  return (
    <SellerScreen title="Help" back>
      ...
      <View style={{ backgroundColor: colors.bgCard, borderWidth: 1, borderColor: colors.border, borderRadius: radius, padding: spacing.xl, marginTop: spacing.xl }}>
        ...
        <Pressable
          ...
          style={{ backgroundColor: colors.accent, borderRadius: pill, paddingVertical: spacing.lg, alignItems: "center", marginTop: spacing.lg }}
        >
