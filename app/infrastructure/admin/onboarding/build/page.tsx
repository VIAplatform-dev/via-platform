...
export default function BuildWizard() {
 ...
 // Real page content for the interactive preview — home is the template, other pages come from the
 ...
 if (slug === "home") return templateBlocks(templateId);
 ...
 body: JSON.stringify({ template: templateId, colors, fonts, blocks: templateBlocks(templateId), shopBlocks: [], extraPages }),
 }).catch(() => {});
