...
import { AdminPage, AdminHeader, TechCard, StatusPill, Toggle, cn } from "../../ui";
...
export default function TaxSettingsPage() {
 ...
 if (!s) return <AdminPage><div className="py-24 text-center text-[13px] text-stone-400">Loading…</div></AdminPage>;
